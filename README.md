...
| `LICENSE` | Copyright © 2026 Mostafa Shahmoradi |
...
Personal/educational use with attribution is allowed. Redistribution or rebranding without permission is prohibited. See `LICENSE`.
